...
## Issues
Due to older PyQt5 and Chromium versions on the 1.0 
release (beta) and the 11.0.1 versions, there is a high chance you
will experience frequent bugs, privacy issues, or website compatibility issues.
The 11.1 version uses PyQt6 and chromium 140, which is MUUUUCHHHH newer.
